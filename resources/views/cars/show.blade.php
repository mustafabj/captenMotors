...
@section('content')
    ...
    <div class="grid w-full space-y-4 sm:space-y-5 px-2 sm:px-0">
        ...
        <div class="kt-card">
            <div class="kt-card-content flex flex-col lg:flex-row items-start lg:items-center justify-between p-3 sm:p-4 lg:p-6 gap-4 lg:gap-6">
                <!-- Image -->
                <div class="flex-shrink-0 w-full sm:w-auto">
                    @if ($car->getFirstMedia('car_images'))
                        <div class="kt-card flex items-center justify-center bg-accent/50 h-[160px] w-full sm:h-[90px] sm:w-[120px] shadow-none">
                ...
                <!-- Actions -->
                <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 w-full sm:w-auto" id="view-actions">
                ...
                <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 hidden w-full sm:w-auto" id="edit-actions">
        ...
        <div class="space-y-3">
            ...
            <div class="kt-tabs kt-tabs-line overflow-x-auto" data-kt-tabs="true">
                <div class="flex flex-nowrap justify-between sm:justify-start w-full gap-3 sm:gap-4">
                    <button class="kt-tab-toggle active whitespace-nowrap text-sm sm:text-base" data-kt-tab-toggle="#tab_1_1">
                    ...
                    <div class="grid grid-cols-1 xl:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
                        ...
                        <div class="kt-card">
                            ...
                            <div class="kt-card-content">
                                <div class="space-y-3 sm:space-y-4">
                                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 py-2 border-b border-gray-200">
                                        <span class="text-gray-600 font-semibold text-sm sm:text-base">Model</span>
                                        <input type="text" class="kt-input w-full sm:w-auto editable-field text-sm sm:text-base" name="model"
                                            value="{{ $car->model }}" data-original="{{ $car->model }}" readonly>
                                    </div>
                                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 py-2 border-b border-gray-200">
                                        <span class="text-gray-600 font-semibold text-sm sm:text-base">Vehicle Category</span>
                                        <input type="text" class="kt-input w-full sm:w-auto editable-field text-sm sm:text-base" name="vehicle_category"
                                            value="{{ $car->vehicle_category ?? '' }}"
                                            data-original="{{ $car->vehicle_category ?? '' }}" placeholder="Not specified"
                                            readonly>
                                    </div>
                                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 py-2 border-b border-gray-200">
                                        <span class="text-gray-600 font-semibold text-sm sm:text-base">Manufacturing Year</span>
                                        <input type="number" class="kt-input w-full sm:w-auto editable-field text-sm sm:text-base" name="manufacturing_year"
                                            value="{{ $car->manufacturing_year }}"
                                            data-original="{{ $car->manufacturing_year }}" min="1900"
                                            max="{{ date('Y') + 1 }}" readonly>
                                    </div>
                                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 py-2 border-b border-gray-200">
                                        <span class="text-gray-600 font-semibold text-sm sm:text-base">Engine Capacity</span>
                                        <input type="text" class="kt-input w-full sm:w-auto editable-field text-sm sm:text-base" name="engine_capacity"
                                            value="{{ $car->engine_capacity }}" data-original="{{ $car->engine_capacity }}"
                                            readonly>
                                    </div>
                                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 py-2 border-b border-gray-200">
                                        <span class="text-gray-600 font-semibold text-sm sm:text-base">Place of Manufacture</span>
                                        <input type="text" class="kt-input w-full sm:w-auto editable-field text-sm sm:text-base"
                                    ...
                                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 py-2 border-b border-gray-200">
                                        <span class="text-gray-600 font-semibold text-sm sm:text-base">Engine Type</span>
                                        <input type="text" class="kt-input w-full sm:w-auto editable-field text-sm sm:text-base" name="engine_type"
                                            value="{{ $car->engine_type ?? '' }}"
                                            data-original="{{ $car->engine_type ?? '' }}" placeholder="Not specified"
                                            readonly>
                                    </div>
                                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 py-2 border-b border-gray-200">
                                        <span class="text-gray-600 font-semibold text-sm sm:text-base">Number of Keys</span>
                                        <input type="number" class="kt-input w-full sm:w-auto editable-field text-sm sm:text-base" name="number_of_keys"
                        ...
                        <div class="kt-card">
                            ...
                            <div class="kt-card-content">
                                <div class="space-y-3 sm:space-y-4">
                                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 py-2 border-b border-gray-200">
                                        <span class="text-gray-600 font-semibold text-sm sm:text-base">Plate Number</span>
                                        <input type="text" class="kt-input w-full sm:w-auto editable-field text-sm sm:text-base" name="plate_number"
                                            value="{{ $car->plate_number ?? '' }}"
                                            data-original="{{ $car->plate_number ?? '' }}" placeholder="Not assigned"
                                            readonly>
                                    </div>
                                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 py-2 border-b border-gray-200">
                                        <span class="text-gray-600 font-semibold text-sm sm:text-base">Status</span>
                                        <div class="status-display">
                                            <span class="kt-badge {{ $status['class'] }}">{{ $status['text'] }}</span>
                                        </div>
                                        <select class="kt-select w-full sm:w-auto editable-field hidden text-sm sm:text-base" name="status"
                                            data-original="{{ $car->status }}">
                        ...
                        <div class="kt-card">
                            ...
                            <div class="kt-card-content">
                                <div class="space-y-3 sm:space-y-4">
                                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 py-2 border-b border-gray-200">
                                        <span class="text-gray-600 font-semibold text-sm sm:text-base">Insurance Expiry</span>
                                        <input type="date" class="kt-input w-full sm:w-auto editable-field text-sm sm:text-base"
                                    ...
                                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 py-2 border-b border-gray-200">
                                        <span class="text-gray-600 font-semibold text-sm sm:text-base">Insurance Status</span>
                                        <div class="text-right sm:text-left">
                                            ...
                                            @if ($daysUntilExpiry > 0)
                                                <span class="kt-badge kt-badge-destructive kt-badge-outline text-xs sm:text-sm">
                                                    Expired {{ $daysUntilExpiry }} days ago
                                                </span>
                                            @elseif($daysUntilExpiry >= -30)
                                                <span class="kt-badge kt-badge-warning kt-badge-outline text-xs sm:text-sm">
                                                    Expires in {{ abs($daysUntilExpiry) }} days
                                                </span>
                                            @else
                                                <span class="kt-badge kt-badge-success kt-badge-outline text-xs sm:text-sm">
                        ...
                        <div class="kt-card">
                            ...
                            <div class="kt-card-content">
                                <div class="space-y-3 sm:space-y-4">
                                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 py-2 border-b border-gray-200">
                                        <span class="text-gray-600 font-semibold text-sm sm:text-base">Purchase Date</span>
                                        <input type="date" class="kt-input w-full sm:w-auto editable-field text-sm sm:text-base" name="purchase_date"
                                            value="{{ $car->purchase_date->format('Y-m-d') }}"
                                            data-original="{{ $car->purchase_date->format('Y-m-d') }}" readonly>
                                    </div>
                                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 py-2 border-b border-gray-200">
                                        <span class="text-gray-600 font-semibold text-sm sm:text-base">Purchase Price</span>
                                        <input type="number" class="kt-input w-full sm:w-auto editable-field text-sm sm:text-base" name="purchase_price"
                                            value="{{ $car->purchase_price }}" data-original="{{ $car->purchase_price }}"
                                            min="0" step="0.01" readonly>
                                    </div>
                                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-2 py-2 border-b border-gray-200">
                                        <span class="text-gray-600 font-semibold text-sm sm:text-base">Expected Sale Price</span>
                                        <input type="number" class="kt-input w-full sm:w-auto editable-field text-sm sm:text-base"
                            ...
                            <div id="options-view-mode">
                                    ...
                                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 sm:gap-4">
                                        @foreach ($car->options as $option)
                                            <div class="kt-card bg-green-50 border border-green-200">
                                                <div class="kt-card-body p-3 sm:p-4">
                                                    <div class="flex items-center">
                                                        <i
                                                            class="ki-filled ki-check-circle text-green-500 text-lg sm:text-xl me-2 sm:me-3"></i>
                                                        <span
                                                            class="text-gray-800 font-semibold text-sm sm:text-base">{{ $option->name }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        @endforeach
                                ...
                                @else
                                    <div class="text-center py-8 sm:py-12">
                                        <i class="ki-filled ki-information-5 text-3xl sm:text-4xl text-gray-400 mb-3 sm:mb-4"></i>
                                        <h4 class="text-base sm:text-lg text-gray-900 mb-2">No options</h4>
                                        <p class="text-sm sm:text-base text-gray-600">No options have been added to this car yet.</p>
                                    </div>
                                @endif
                            </div>
                        ...
                        <div class="kt-card-content">
                            ...
                            <div id="inspection-view-mode">
                                @if ($car->inspection)
                                    ...
                                    <div class="mt-8">
                                        <h5 class="text-md font-semibold mb-4">Body Inspection</h5>
                    ...
                    <div class="kt-card">
                        ...
                        <div class="kt-card-content">
                            ...
                            <div id="financial-view-mode">
                                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-{{ $car->purchase_price ? '4' : '2' }} gap-4 sm:gap-6">
                                    @if ($car->purchase_price)
                                        <div class="text-center p-3 sm:p-4 bg-green-50 rounded-lg">
                                            <div class="text-lg sm:text-xl lg:text-2xl font-semibold text-green-600">
                                                ${{ number_format($car->purchase_price, 2) }}</div>
                                            <div class="text-xs sm:text-sm text-gray-600">Purchase Price</div>
                                        </div>
                                    @endif
                                    <div class="text-center p-3 sm:p-4 bg-blue-50 rounded-lg">
                                        <div class="text-lg sm:text-xl lg:text-2xl font-semibold text-blue-600">
                                            ${{ number_format($car->expected_sale_price, 2) }}</div>
                                        <div class="text-xs sm:text-sm text-gray-600">Expected Sale Price</div>
                                    </div>
                                    @php
                                    ...
                                    <div class="text-center p-3 sm:p-4 bg-yellow-50 rounded-lg">
                                        <div class="text-lg sm:text-xl lg:text-2xl font-semibold text-yellow-600">
                                            ${{ number_format($totalCosts, 2) }}
                                        </div>
                                        <div class="text-xs sm:text-sm text-gray-600">Total Equipment Costs</div>
                                    </div>
                                    @if ($car->purchase_price)
                                        <div
                                            class="text-center p-3 sm:p-4 {{ $profit >= 0 ? 'bg-green-50' : 'bg-red-50' }} rounded-lg">
                                            <div
                                                class="text-lg sm:text-xl lg:text-2xl font-semibold {{ $profit >= 0 ? 'text-green-600' : 'text-red-600' }}">
                                                ${{ number_format($profit, 2) }}</div>
                                            <div class="text-xs sm:text-sm text-gray-600">Estimated Profit</div>
                                        </div>
                                    @endif
                                </div>
                            </div>
                                            ...
                                            <table class="w-full" id="equipment-costs-table">
                                                <thead>
                                                    <tr class="border-b border-gray-200">
                                                        <th class="text-left py-2 sm:py-3 px-2 sm:px-4 font-semibold text-sm sm:text-base">Description</th>
                                                        <th class="text-left py-2 sm:py-3 px-2 sm:px-4 font-semibold text-sm sm:text-base">Amount</th>
                                                        <th class="text-left py-2 sm:py-3 px-2 sm:px-4 font-semibold text-sm sm:text-base hidden sm:table-cell">Date</th>
                                                        <th class="text-left py-2 sm:py-3 px-2 sm:px-4 font-semibold text-sm sm:text-base hidden lg:table-cell">Added By</th>
                                                        <th class="text-left py-2 sm:py-3 px-2 sm:px-4 font-semibold text-sm sm:text-base">Status</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    @foreach ($equipmentCosts->sortByDesc('cost_date') as $cost)
                                                        <tr class="border-b border-gray-200">
                                                            <td class="py-2 sm:py-3 px-2 sm:px-4 text-sm sm:text-base">{{ $cost->description }}</td>
                                                            <td class="py-2 sm:py-3 px-2 sm:px-4 font-semibold text-sm sm:text-base">
                                                                ${{ number_format($cost->amount, 2) }}</td>
                                                            <td class="py-2 sm:py-3 px-2 sm:px-4 text-sm sm:text-base hidden sm:table-cell">{{ $cost->cost_date->format('M j, Y') }}
                                                            </td>
                                                            <td class="py-2 sm:py-3 px-2 sm:px-4 text-gray-600 text-sm sm:text-base hidden lg:table-cell">
                                                                {{ $cost->user->name ?? '—' }}
                                                            </td>
                                                            <td class="py-2 sm:py-3 px-2 sm:px-4">
                                                                <span class="kt-badge {{ $cost->getStatusBadgeClass() }} text-xs sm:text-sm">
                                                                    {{ $cost->getStatusText() }}
                                                                </span>
                                                            </td>
                                                        </tr>
                                    ...
                                    <div class="kt-card">
                                        ...
                                        <div class="kt-card-content">
                                            @if ($car->getMedia('car_license')->count() > 0)
                                                <div id="car-license-gallery" class="w-full">
                                                    @foreach ($car->getMedia('car_license') as $license)
                                                        <div class="relative group cursor-pointer w-full"
                                                            ...
                                                            <img src="{{ $license->getUrl() }}" alt="Car License"
                                                                class="w-full h-48 sm:h-64 lg:h-80 object-contain rounded-lg shadow-md transition-transform duration-200 group-hover:scale-105">
                                                            <div
                                                                ...
                                                                <i
                                                                    class="ki-filled ki-eye text-white opacity-0 group-hover:opacity-100 transition-opacity duration-200 text-lg sm:text-xl"></i>
                                                            </div>
                                                        </div>
                                                    @endforeach
                                                </div>
                                            @else
                                                <div class="text-center py-8 sm:py-12">
                                                    <i class="ki-filled ki-picture text-3xl sm:text-4xl text-gray-400 mb-3 sm:mb-4"></i>
                                                    <h4 class="text-base sm:text-lg text-gray-900 mb-2">No License Image</h4>
                                                    <p class="text-sm sm:text-base text-gray-600">No car license image has been uploaded.</p>
                                                </div>
                                            @endif
                                        </div>
                                    </div>
                                        ...
                                        <div class="kt-card-content">
                                            @if ($car->getMedia('car_images')->count() > 0)
                                                <div id="car-images-gallery"
                                                    class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-2 sm:gap-3 lg:gap-4">
                                                    @foreach ($car->getMedia('car_images') as $image)
                                                        <div class="relative group cursor-pointer"
                                                            data-src="{{ $image->getUrl() }}">
                                                            <img src="{{ $image->getUrl() }}" alt="Car Image"
                                                                class="w-full h-24 sm:h-28 lg:h-32 object-cover rounded-lg shadow-md transition-transform duration-200 group-hover:scale-105">
                                                            <div
                                                                class="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-20 transition-all duration-200 rounded-lg flex items-center justify-center">
                                                                <i
                                                                    class="ki-filled ki-eye text-white opacity-0 group-hover:opacity-100 transition-opacity duration-200 text-lg sm:text-xl"></i>
                                            ...
                                            @else
                                                <div class="text-center py-8 sm:py-12">
                                                    <i class="ki-filled ki-picture text-3xl sm:text-4xl text-gray-400 mb-3 sm:mb-4"></i>
                                                    <h4 class="text-base sm:text-lg text-gray-900 mb-2">No Car Images</h4>
                                                    <p class="text-sm sm:text-base text-gray-600">No car images have been uploaded.</p>
                                                </div>
                                            @endif
                                        </div>
                                    </div>
    ...
    <div class="kt-modal" data-kt-modal="true" id="addCostModal">
        <div class="kt-modal-content max-w-[90vw] sm:max-w-[500px] top-[5%] mx-2 sm:mx-auto">
            <div class="kt-modal-header">
                <h3 class="kt-modal-title text-base sm:text-lg">Add Equipment Cost</h3>
            ...
            <div class="kt-modal-body">
                <form method="POST" id="addCostForm">
                    ...
                    <div class="space-y-4 sm:space-y-5">
                        <!-- Date Field -->
                        <div class="kt-form-item">
                            <label for="cost_date" class="kt-form-label text-sm sm:text-base">
                                Date <span class="text-red-500">*</span>
                            </label>
                            <div class="kt-form-control">
                                <input type="date" name="cost_date" id="cost_date" required class="kt-input w-full text-sm sm:text-base">
                        ...
                        <!-- Description Field -->
                        <div class="kt-form-item">
                            <label for="description" class="kt-form-label text-sm sm:text-base">
                                Description <span class="text-red-500">*</span>
                            </label>
                            <div class="kt-form-control">
                                <textarea name="description" id="description" rows="3" required class="kt-textarea w-full text-sm sm:text-base"
                        ...
                        <!-- Amount Field -->
                        <div class="kt-form-item">
                            <label for="cost_amount" class="kt-form-label text-sm sm:text-base">
                                Amount <span class="text-red-500">*</span>
                            </label>
                            <div class="kt-form-control">
                                <input type="number" name="amount" id="cost_amount" required min="0"
                                    step="0.01" class="kt-input w-full pl-8 text-sm sm:text-base" placeholder="0.00">
                                <div class="kt-form-message"></div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="kt-modal-footer">
                ...
                <div class="flex flex-col sm:flex-row gap-2 sm:gap-4">
                    <button class="kt-btn kt-btn-secondary w-full sm:w-auto" data-kt-modal-dismiss="#addCostModal">
                        Cancel
                    </button>
                    <button type="submit" class="kt-btn kt-btn-primary w-full sm:w-auto" form="addCostForm" id="submitCostBtn">
    ...
    <div class="kt-modal kt-modal-center" data-kt-modal="true" id="sellCarModal">
        <div class="kt-modal-content max-w-[90vw] sm:max-w-[500px] max-h-[95%] mx-2 sm:mx-auto">
            <div class="kt-modal-header">
                <h3 class="kt-modal-title text-base sm:text-lg">Sell Car: <span id="sellCarModel"></span></h3>
            ...
            <div class="kt-modal-body">
                <form id="sellCarForm" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="space-y-3 sm:space-y-4">
                        <div>
                            <label for="sale_price" class="kt-label text-sm sm:text-base">Sale Price *</label>
                            <input type="number" name="sale_price" id="sale_price" class="kt-input w-full text-sm sm:text-base" required
                                min="0" step="0.01">
                        </div>
                        <div>
                            <label for="payment_method" class="kt-label text-sm sm:text-base">Payment Method *</label>
                            <select name="payment_method" id="payment_method" class="kt-select w-full text-sm sm:text-base" required
                        ...
                        <div class="hidden" id="separatedFields">
                            <div>
                                <label for="paid_amount" class="kt-label text-sm sm:text-base">Paid Amount</label>
                                <input type="number" name="paid_amount" id="paid_amount" class="kt-input w-full text-sm sm:text-base" min="0"
                                    step="0.01">
                            </div>
                            <div class="mt-3">
                                <label for="remaining_amount" class="kt-label text-sm sm:text-base">Remaining Amount</label>
                                <input type="number" name="remaining_amount" id="remaining_amount" class="kt-input w-full text-sm sm:text-base"
                                    min="0" step="0.01">
                            </div>
                        </div>
                        <div>
                            <label for="attachment" class="kt-label text-sm sm:text-base">Attachment</label>
                            <input type="file" name="attachment" id="attachment" class="kt-input w-full text-sm sm:text-base">
                        </div>
                    </div>
                </form>
            </div>
            <div class="kt-modal-footer">
                <div class="flex flex-col sm:flex-row gap-2 sm:gap-4">
                    <button class="kt-btn kt-btn-secondary w-full sm:w-auto" data-kt-modal-dismiss="#sellCarModal">
                        Cancel
                    </button>
                    <button type="submit" form="sellCarForm" class="kt-btn kt-btn-primary w-full sm:w-auto">
                        Confirm Sale
                    </button>
                </div>
            </div>

                            ...
                            <div class="kt-card-content">
                                ...
                                <div class="flex justify-between items-center py-2 border-b border-gray-200">
                                    ...
                                    <input type="text" class="kt-input w-auto editable-field" name="color"
                                        value="{{ $car->color ?? '' }}"
                                        data-original="{{ $car->color ?? '' }}" placeholder="Not specified"
                                        readonly>
                                </div>
                                <div class="flex justify-between items-center py-2 border-b border-gray-200">
                                    <span class="text-gray-600 font-semibold block">Mileage</span>
                                    <input type="number" class="kt-input w-auto editable-field" name="mileage"
                                        value="{{ $car->mileage ?? '' }}"
                                        data-original="{{ $car->mileage ?? '' }}" placeholder="Not specified"
                                        readonly>
                                </div>
                                <div class="flex justify-between items-center py-2 border-b border-gray-200">

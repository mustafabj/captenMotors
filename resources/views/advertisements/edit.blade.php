...
<div class="grid w-full space-y-5">
    ...
    <div class="flex justify-between items-center">
        <div>
            ...
            <p class="text-sm text-gray-500">Update advertisement information</p>
        </div>
        <div>
    ...
    <div class="kt-card">
        ...
        <div class="kt-card-content p-5">
            <form method="POST" action="{{ route('advertisements.update', $advertisement) }}" class="space-y-5">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <input type="date" name="expiration_date" id="expiration_date" 
                               ...
                               value="{{ old('expiration_date', $advertisement->expiration_date->format('Y-m-d')) }}" 

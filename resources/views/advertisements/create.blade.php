                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
                        <div>
                            ...
                            <select name="car_id" id="car_id"
                                class="kt-select w-full @error('car_id') border-red-500 @enderror" data-kt-select="true"
                                data-kt-select-placeholder="Select a car"
                            ...
                            @enderror
                            <p class="mt-1 text-sm text-gray-500">Only cars that are not sold and not already advertised are
                                shown.</p>
                        </div>

                        <div>
                            <label for="expiration_date" class="block text-sm font-medium text-gray-700 mb-2">Expiration
                                Date *</label>
                            <input type="date" name="expiration_date" id="expiration_date"
                                class="kt-input w-full @error('expiration_date') border-red-500 @enderror"
                                value="{{ old('expiration_date') }}" min="{{ date('Y-m-d', strtotime('+1 day')) }}"
                                required>
                        ...
                        <div>
                            <label for="offer_price" class="block text-sm font-medium text-gray-700 mb-2">Offer Price
                                *</label>
                            <div class="relative">
                                <input type="number" name="offer_price" id="offer_price"
                                    class="kt-input w-full @error('offer_price') border-red-500 @enderror"
                                    value="{{ old('offer_price') }}" step="0.01" min="0" placeholder="0.00"
                                    required>
                            </div>
                            @error('offer_price')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        ...
                        <div>
                            <label for="sale_price" class="block text-sm font-medium text-gray-700 mb-2">Sale Price
                                *</label>
                            <div class="relative">
